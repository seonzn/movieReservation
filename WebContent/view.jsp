...
String url = "jdbc:mysql://172.16.107.149:3306/movie";
	...
	try {
		...
		String sql = "SELECT USERNAME, TITLE, MEMO, TIME, HIT, STAR, MOVIENAME FROM board WHERE NUM=" + idx;
   ...
   <table width="413">
    ...
    <tr>
     ...
     <tr height="1" bgcolor="#dddddd"><td colspan="4" width="407"></td></tr>
      <tr>
      <td width="0">&nbsp;</td>
      <td align="center" width="76">리뷰평점</td>
      <td width="319"><%=star%>★</td>
      <td width="0">&nbsp;</td>
     </tr>
     <tr height="1" bgcolor="#dddddd"><td colspan="4" width="407"></td></tr>
                <tr>
