...
<div id="box">
		...
		<div id="main">
		<br>
		<center><h2 style="color:black"> 패밀리 영화관</h2> </center>
		<div class="cycle-slideshow"
    cycle-slideshow data-cycle-loader="wait"
    data-cycle-timeout=1000
>

    <img src="./movie_img/place1.PNG">
    <img src="./movie_img/place2.PNG">
    <img src="./movie_img/place3.PNG">
    <img src="./movie_img/place4.PNG">
