...
%>
	<a href="#" onclick="javascript:window.open('view.jsp?idx=<%=idx%>&pg=<%=pg%>','new','width=550, height=550')"><%=title %></a>
<%
	if(year.equals(yea)){
%>
			<img src='./img/new.jpg' />
  ...
  <tr>
	<td align="center">
		...
		%>
		  ...
		  <tr align="center">
   <td><input type=button value="글쓰기" onclick="open('write.jsp','new','width=600,height=400')" ></td>
  </tr>
 </table>
</div>
</div>
